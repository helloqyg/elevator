	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><?php if(!empty($news["id"])): ?>修改<?php else: ?>添加<?php endif; ?>展馆</h3>
			</div>
			<div class="panel-body">
				<form role="form" class="form-horizontal" method="post" action="">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="hall_num" id="keywords" value="<?php echo ((isset($news["hall_num"]) && ($news["hall_num"] !== ""))?($news["hall_num"]):''); ?>" placeholder="展位号，如'5.1'">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-5">展馆状态</label>
							...
							<label class="radio-inline">
								<input type="radio" name="status" value="1" <?php if(($news["status"]) == "1"): ?>checked<?php endif; ?> /> 启用
							</label>
							<label class="radio-inline">
								<input type="radio" name="status" value="0" <?php if(($news["status"]) == "0"): ?>checked<?php endif; ?>/> 不启用
							</label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="area" id="keywords" value="<?php echo ((isset($news["area"]) && ($news["area"] !== ""))?($news["area"]):''); ?>" placeholder="展馆分区，如A,B,C">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="position" id="keywords" value="<?php echo ((isset($news["position"]) && ($news["position"] !== ""))?($news["position"]):''); ?>" placeholder="坐标，如0，0，1，2">
					...
					<div class="form-group text-center">
						...
						<button type="submit" class="btn btn-info btn-single pull-center ajax-post"  target-form="form-horizontal"><?php if(!empty($news["id"])): ?>修改<?php else: ?>添加<?php endif; ?>展馆</button>
					</div>
				</form>
			</div>
		</div>
...
$(function(){
	...
	$('#file_upload').uploadify({
		...
		'uploader'    : "<?php echo U('Chart/fileupload');?>",
		"buttonText"  : "上传图片",
