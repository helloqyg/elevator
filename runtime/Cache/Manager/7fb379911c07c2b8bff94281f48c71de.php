				...
				<form  class="form-horizontal" id="form" method="post" action="" >
					<table class="table table-striped">
						...
						<tr>
							<td>
								<div class="form-group">
									<span class="col-sm-4 col-xs-3 control-label">原始展位:</span>
									<div class="col-sm-5 col-xs-8">
										<input type="text" class="form-control"  value="<?php echo strtoupper($booth_num);?>"  disabled>
										<label class="notice_info" style="padding-left:0px;margin-left:0px;"></label>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<td>
								<div class="form-group">
									<span class="col-sm-4 col-xs-3 control-label">修改展位:</span>
									<div class="col-sm-5 col-xs-8">
										<select name="newid" class="form-control">
											<?php if(is_array($booth)): $i = 0; $__LIST__ = $booth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo strtoupper($v['booth_num']);?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
										<label class="notice_info" style="padding-left:0px;margin-left:0px;"></label>
									</div>
								</div>
						...
						<tr>
							<td class="text-center">
									...
									<button type="submit" class="btn btn-info ajax-post" target-form="form-horizontal">修改展位</button>
							</td>
						</tr>
					</tbody>
					</table>
...
<script src="/public/js/validform.min.js"></script>
<script type="text/javascript">
	$(function(){
		$(".form-horizontal").Validform({
			tiptype:function(msg,o,cssctl){
				var	objtip = o.obj.siblings(); 
