						  ...
						  <tbody>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							  ...
							  <td class="text-center">
								<a class="btn btn-info btn7" href="javascript:void(0)" attr="<?php echo ($v["tp_id"]); ?>"  role="button">修改</a>
								<a class="btn btn-danger btn8" href="javascript:void(0);"  attr="<?php echo ($v["tp_id"]); ?>" role="button">删除</a>
							   </td>
		...
		$(".btn6").click(function(){
					...
					window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.input,{
						onOk:function(v){
							$.ajax({
								type: "POST",
							    url: "<?php echo U('adver/change_type');?>",
						    	data: {'v':v,flag:1},
