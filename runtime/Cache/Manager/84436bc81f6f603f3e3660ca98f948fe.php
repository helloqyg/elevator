			...
			<div class="row">
					<table class="table table-striped">
							...
							<td>
								<div class="form-group">
									...
									<div class="col-sm-5 col-xs-8">
										<input type="text" class="form-control" name="SITE_NAME" value="<?php echo ($invoice['company']); ?>" disabled>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<td>
								<div class="form-group">
									<span class="col-sm-4 col-xs-3 control-label">汇款金额:</span>
									<div class="col-sm-5 col-xs-8">
										<input type="text" class="form-control" name="SITE_NAME" value="<?php echo ($invoice['price']); ?>" disabled>
									</div>
								</div>
							</td>
						</tr>						
						<tr>
							<td>
								<div class="form-group">
									<span class="col-sm-4 col-xs-3 control-label">汇款凭证:</span>
									<div class="col-sm-5 col-xs-8">
										<a class="example-image-link" href="<?php echo ($invoice["fukuan"]); ?>" data-lightbox="example-1">
										<img class="example-image" src="<?php echo ($invoice["fukuan"]); ?>" alt="image-1"  height="200px"/>
										</a>
									</div>
								</div>
							</td>
								...
								<div class="form-group">
									...
									<div class="col-sm-5 col-xs-8">
										<label class="radio-inline">
											<input type="radio" name="status" value="1" <?php if(($invoice["status"]) == "1"): ?>checked<?php endif; ?> /> 通过
										</label>
										<label class="radio-inline">
											<input type="radio" name="status" value="0" <?php if(($invoice["status"]) == "0"): ?>checked<?php endif; ?>/> 不通过
										</label>
									</div>
								</div>
							</td>
