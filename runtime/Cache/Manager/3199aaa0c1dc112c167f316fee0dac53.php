...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><h3 class="panel-title" style="width:350px;"><p style="display:block; float:left; padding-right:20px;">广告管理</p><form method="get" action="<?php echo U('adver');?>">
						  ...
						  <tbody>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							  ...
							  <td scope="row" class="text-center">
								<?php echo ($v["goods_address"]); ?>
							  </td>
							 <td scope="row" class="text-center">
								<?php echo get_ad_area($v['ae_id']);?>
							  </td>
							  <td class="text-center"><?php echo get_ad_cat($v['cat_id']);?></td>
							  <td class="text-center"><?php echo get_ad_bot_count($v['goods_id']);?>/<?php echo get_ad_count($v['goods_id']);?></td>
							  <td class="text-center">
								<a class="btn btn-warning" href="<?php echo U('Adver/change_list',array('id'=>$v['goods_id']));?>" role="button">修改</a>
								<a class="btn btn-info" href="<?php echo U('Adver/addresslist',array('id'=>$v['goods_id']));?>" role="button">详情</a>
								<a class="btn btn-danger btn8" href="javascript:void(0);"  attr="<?php echo ($v["goods_id"]); ?>" role="button">删除</a>
							   </td>
...
$(function(){
	$(".add-area").click(function(){
		window.location.href="<?php echo U('Adver/area');?>";
	})
	$(".add-type").click(function(){
		window.location.href="<?php echo U('Adver/type');?>";
	})
	$(".add-info").click(function(){
		window.location.href="<?php echo U('Adver/change_list');?>";
	})
	$(".add-rbac").click(function(){
		window.location.href="<?php echo U('Adver/rbac');?>";
	})
})
				//删除操作
	$('.btn8').click(function(){
