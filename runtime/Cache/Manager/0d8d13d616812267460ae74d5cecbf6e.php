	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title" style="width:350px;"><p style="display:block; float:left; padding-right:20px;">展位管理</p><form method="get" action="<?php echo U('booth');?>">
						...
						<table class="table table-hover news-list">
						  <thead>
							<tr>
							  ...
							  <th class="col-md-2 text-center">展馆名称</th>
							  <th class="col-md-2 text-center">展位面积</th>
							  <th class="col-md-2 text-center">展位定金</th>
						  ...
						  <tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single): $mod = ($i % 2 );++$i;?><tr>
							  <th scope="row" class="text-center">
							 	<?php echo ($single["booth_num"]); ?>
							 </th>
							  <td class="text-center">
							  		<?php echo ($booth_title); ?>馆
							  </td>
							 <td class="text-center">
							 ...
							 <?php echo ($single['area']); ?> 平方米
							  ...
							  <td class="text-center">
							  	<?php if(($single["status"]) == "1"): ?>销售<?php endif; ?>
							  	<?php if(($single["status"]) == "0"): ?>预留<?php endif; ?>
							  	<?php if(($single["status"]) == "2"): ?>已销售<?php endif; ?>
							  </td>
							  <td class="text-center">
								<a class="btn btn-info" href="<?php echo U('Chart/edit_booth',array('aid'=>$single['id']));?>" role="button">修改</a>
